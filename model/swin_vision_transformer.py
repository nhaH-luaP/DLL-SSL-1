...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, attn_drop=0., proj_drop=0.,
        ...
        self.max = torch.log(torch.tensor(100.)).to(device="cuda")
...
class SWINVisionTransformerModule(L.LightningModule):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],
                 window_size=7, mlp_ratio=4., qkv_bias=True,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,
        ...
        super().__init__()
        self.model = SwinTransformerV2(img_size=img_size, patch_size=patch_size, in_chans=in_chans, num_classes=num_classes,
